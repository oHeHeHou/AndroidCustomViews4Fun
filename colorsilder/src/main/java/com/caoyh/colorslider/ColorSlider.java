...
public class ColorSlider extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mUnderColor = a.getColor(R.styleable.ColorSlider_base_color, Color.parseColor("#e5e5e5"));
        mProgressColor = a.getColor(R.styleable.ColorSlider_progress_color, Color.parseColor("#ff6600"));
        mTextColor = a.getColor(R.styleable.ColorSlider_bottom_text_color, Color.parseColor("#e5e5e5"));
        mLineThick = a.getDimensionPixelSize(R.styleable.ColorSlider_line_height, DEFAULT_LINE_THICK);
        mSlideBarRadius = a.getDimensionPixelSize(R.styleable.ColorSlider_slide_bar_radius, DEFAULT_SLIDE_BAR_RADIUS);
        mTextSize = a.getDimensionPixelSize(R.styleable.ColorSlider_bottom_text_size, DEFAULT_TEXT_SIZE);
